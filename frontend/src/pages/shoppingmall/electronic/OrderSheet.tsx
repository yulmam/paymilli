...
const THE_FREE_SHIPPING_MINIMUM_AMOUNT = 300000;
const THE_DELIVERY_CHARGE = 30000;
...
export default function OrderSheet() {
  ...
  window.notifyPaymilli = (data: PaymentApproveResponseType) => {
    ...
    navigate(`/mall/electronic/order/complete`, {
      state: {
  ...
  const openPayPopup = () => {
    ...
    window.open(
      `/payment?amount=${totalCost}&mall=Samsung Mall`,
      "paymentWindow",
      popupOptions,
    );
  };
